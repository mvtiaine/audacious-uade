...
# Notes
- The default driver (HQ) is my own, which has a floating-point mixer, better tempo (BPM) precision, 8-tap windowed-sinc interpolation, stereo sample support and ModPlug Tracker's extended filter range
