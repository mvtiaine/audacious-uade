...
const map<string, bool> modland_incoming ({
    ...
    {"vault/Sonix", false},
    {"vault/TFMX merged", false},
    {"vault/TFMX single sample set", false},
    {"workshop/NP1", false},
    {"workshop/NP3", false},
    {"workshop/P40A", false},
    {"workshop/P40B", false}, 
    ...
    {"laboratory/Martin Bazley tracker", false},
    {"laboratory/Quartet_ST_(4q)", false},
    {"laboratory/Quartet ST without smp-files", false},
    ...
    {"warehouse/MOD", false},
    {"delivery bay/2022-09-27-from_EpicTyphlosion", false},
    {"delivery bay/Amiga game mods", false},
    {"delivery bay/croy", false},
    {"delivery bay/from_Chip", false},
    {"delivery bay/lemmings_music_mod", false},
    {"delivery bay/mbnet_mods", false},
    {"delivery bay/mod_jp", false},
